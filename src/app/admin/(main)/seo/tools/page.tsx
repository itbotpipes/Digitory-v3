...
export default function SeoTools() {
  ...
  return (
    <div className="p-6 md:p-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-fade-in">
      {/* Sitemap Section */}
        ...
        <div>
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-zinc-500 dark:text-zinc-400 text-sm mt-1">Guide AI models & LLM agents.</p>
            </div>
          </div>
          ...
          <textarea 
            ...
            className="w-full h-72 bg-zinc-900 dark:bg-black border border-zinc-800 rounded-2xl p-5 font-mono text-sm text-amber-300 outline-none focus:border-[#FF4F18] focus:ring-1 focus:ring-[#FF4F18] resize-none mb-8 custom-scrollbar shadow-inner"
